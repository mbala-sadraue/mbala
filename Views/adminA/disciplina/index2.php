        ...
        echo '<section class="section_main">
          ...
          <section>
                  ...
                  $ativo = 1;
								...
								echo'
								<ul>';
								$dadosD = listaCurso($index_idDeparta,$ativo);
												$d = new ArrayIterator($dadosD);
												while ($d->valid()){     
													echo'<li><h3 class="geral-title-h3">'. $d->current()->NomeCurso.'</h3>';
													$idCurso = $d->current()->idCurso;
                           ...
                           <a href="'.$url2.'adminA/disciplina/edita.php?id='.$dado->current()->idDisciplina.'&& idD='.$d->current()->idCurso.'" ><img src="'.$url2.'assets/img/edita.png"  class="img edita"/></a>
									 				</span>
