<?php
  ...
  if($permissao ==2){// VERIFCA APERMISSÃO
    if((isset($_GET["idCurso"]) && $_GET["idCurso"]>0  ) && (isset($_GET["nomeCurso"]) != null)){
        ...
        echo '<section class="section_main">
          ...
          <section>
                ...
                echo'<li><h3 class="geral-title-h3">'.$nomeCurso.'</h3>';
                           ...
                           <a href="'.$url2.'adminA/disciplina/edita.php?id='.$dado->current()->idDisciplina.'&& idD='.$idCurso.'" ><img src="'.$url2.'assets/img/edita.png"  class="img edita"/></a>
									 				</span>
