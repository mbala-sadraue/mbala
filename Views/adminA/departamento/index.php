											...
											<tr class="tabela-body-tr">
												...
												<td class="tabela-body-td">'.$dado->current()->idDeparta.'</td>
									 			<td class="tabela-body-td">'.$dado->current()->NomeDeparta.'
												 	...
												 	<td class="tabela-body-td">'.$curso.'</td>
									 			<td class="tabela-body-td">'.$dado->current()->idAdminG.'</td>
									 			<td class="tabela-body-td">
                           <span class="span-img-edite">
                           <a href="'.$url2.'adminG/departamento/edita.php?id='.$dado->current()->idDeparta.'" ><img src="'.$url2.'assets/img/edita.png"  class="img edita"/></a>
									 				</span>
									...
									echo '
										<div class="corpo-message0">
											<div class="message0">
												...
												<a href="departamento.php">Por favor adicione  Usuarios para poder  visualizar</a></p>
											</div>
										</div>
										';
								}
