<?php
  ...
  if($permissao ==1){
    $public  = 1;
		 if((isset($_GET["idCurso"]) && $_GET["idCurso"]>0) && isset($_GET["idDeparta"])){
      ...
      echo $aside;
        echo '<section class="section_main">
          ...
          <section>
                  ...
                  if(listarTurma2($anoLetivo,$idDeparta,$public,$idCurso)){
								echo'
								<ul>
                    	<li><h3 class="geral-title-h3">Lista de Turma da '.$nomeCurso.'</h3>';
                    $dados =	listarTurma2($anoLetivo,$idDeparta,$public,$idCurso);
                 // print_r($dados);
                        ...
                        <th class="tabela-head-th">AÇÕES</th>
										...
										';
											...
											while ($dado->valid()){
												...
												$quantAluno 		= turmaAluno($dados = array(1=>$idTurma,$idCurso,$anoEscolar,$anoLetivo,$idDeparta,$ativo));
