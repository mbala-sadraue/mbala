  ...
  <div class="corpo">
    <div class="sub_corpo">
      <?php  
       ...
       require_once "../../../App/Models/anoletivo.php";
          ...
          <section>
                  ...
                  //  print_r($dados);
                        ...
                        <th class="tabela-head-th">POSIÇÃO</th>
                         ...
                         <th class="tabela-head-th">ANO LETIVO</th>
                         <th class="tabela-head-th">Data De Registro</th>
										 ...
										 echo '
											<tr class="tabela-body-tr">
												<td class="tabela-body-td">';
													if($dado->current()->AnoAtivo ==1){echo"Ativo";}else{echo"Desativo";}
												echo'</td>
												<td class="tabela-body-td">'.$count.'</td>
                        <td class="tabela-body-td">'.$dado->current()->idAno_letivo.'</td>
                        <td class="tabela-body-td"><a href="">'.$dado->current()->NomeAnoletivo.'</a></td>
                       <td class="tabela-body-td">'.$dado->current()->AnoDataRegistro.'</td>
                       
												<td class="tabela-body-td">
                           <span class="span-img-edite">
                           <a href="" ><img src="'.$url2.'assets/img/edita.png"  class="img edita"/></a>
									 				</span>
									 			</td>
											</tr>
											</tr>';
