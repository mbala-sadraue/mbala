      ...
      echo $aside;
        echo '<section class="section_main">
          ...
          <section>
											...
											<tr class="tabela-body-tr">
												<td class="tabela-body-td">
													<form method="post" action="action.php">
														<input type="hidden" name="id" id="status" value="'.$dado->current()->idAdminA.'">
														<input type="hidden" name="status" id="status" value="'.$dado->current()->admina_Ativo.'">
														<input type="checkbox" name="status" id="status"'; if($dado->current()->admina_Ativo==1){ echo "checked";} echo' value="'.$dado->current()->admina_Ativo.'"
                           ...
                           <a href="'.$url2.'adminG/admina/edita.php?id='.$dado->current()->idAdminA.'" ><img src="'.$url2.'assets/img/edita.png"  class="img edita"/></a>
									 				</span>
									 				<span class="span-img-delete">
									 					<a href="'.$urlF2.'"insertAdmina.php?acao=delete&id='.$dado->current()->idAdminA.'"><img src="'.$url2.'assets/img/elimina.png" class="img delete" /></a>
									 				</span>
									 			</td>
									...
									echo '
										<div class="corpo-message0">
											<div class="message0">
												<p class="">Nenhum dados ou Administrador registrado!<br/>
												<a href="cadastraAdmin.php">Por favor adicione  Administrador para poder  visualizar</a></p>
											</div>
										</div>
										';
								}
									...
									<tr>
										...
										<div class="corpo-btn-add btn-div">
											...
											<div class="corpo-btn-inativo btn-div">
												...
												<div class="corpo-btn-add btn-div">
													<a href="'.$url2.'adminG/admina/cadastraAdmin.php" class=" btn-add estilo-btn">Adiciona</a>
												</div>
