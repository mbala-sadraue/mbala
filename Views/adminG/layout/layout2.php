<?php
    ...
    $header = '<header class="main_header">
						...
						<nav class="main_nav">
							...
							<li class="ul_li_main">
								...
								<li class="ul_li_main">
									...
									<ul class="li_ul2 hide">
										<li class="ul2_li">
											<a href="'.$url2.'adminG/anoEscolar" class="li2_a2">Ano letivo</a>
										</li>
										<li class="ul2_li">
											<a href="'.$url2.'adminG/anoEscolar/cadastra-anoescolar.php" class="li2_a2">Cadastra ano Letivo</a>
										</li>
									</ul>
								</li>	
								<li class="ul_li_main">
