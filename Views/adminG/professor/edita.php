    ...
    <div class="sub_corpo">
      <?php  
        ...
        echo '<section class="main_section">
          ...
          if(buscaDadosProfessor($id)!=null){
                     ...
                     echo'</select>
                         ...
                         <li class="form_li">
                          ...
                          <div class="form_input">
                            ...
                            <input type="hidden" name="idAdmin" value="'.$dado->current()->idProfessor.'" class="form_input_main input_valida">
                          </div>
                        </li>
                      </ul>';
                        $dado->next(); 
