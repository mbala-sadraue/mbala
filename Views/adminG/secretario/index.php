      ...
      echo $aside;
        echo '<section class="section_main">
          ...
          <section>
                           ...
                           <a href="'.$url2.'adminG/secretario/edita.php?id='.$dado->current()->idSecretario.'" ><img src="'.$url2.'assets/img/edita.png"  class="img edita"/></a>
									 				</span>
									...
									<tr>
										...
										<div class="corpo-btn-add btn-div">
											...
											<div class="corpo-btn-inativo btn-div">
												...
												<div class="corpo-btn-add btn-div">
													<a href="'.$url2.'adminG/secretario/cadastra-secretario.php" class=" btn-add estilo-btn">Adiciona</a>
												</div>
