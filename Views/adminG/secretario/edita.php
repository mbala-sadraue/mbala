        ...
        echo '<section class="main_section">
          <div class="section_main">
            <header class="section_header">
              <h1 class="section_header_h1">Editar <small>Secretário/a</small></h1>
            </header>
          </div>
          <article class="article_main_form">';
          if(buscaDadosSecretario($id)!=null){
                    ...
                    <div class="form-right">
                     ...
                     echo'</select>
                         ...
                         <li class="form_li">
                          ...
                          <div class="form_input">
                            <input type="text" name="usuario" value="'.$dado->current()->Usuario.'"class="form_input_main input_valida" placeholder="Digite o usuario">
                          </div>
                        </li>
                         <li class="form_li">
                          <label class="form_label">Senha</label>
                          <div class="form_input">
                            <input type="password" name="password" value="'.$dado->current()->Senha.'" class="form_input_main input_valida" placeholder="Digite a senha">
                          </div>
                        </li>
                         <li class="form_li">
                          ...
                          <div class="form_input">
                            ...
                            <input type="hidden" name="idAdmin" value="'.$dado->current()->idSecretario.'" class="form_input_main input_valida">
                          </div>
                        </li>
                      </ul>';
                        $dado->next(); 
