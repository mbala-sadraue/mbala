<?php
	...
	if($permissao ==3){// VERIFICA PERMISSÃO
?>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="corpo">
		<div class="sub_corpo">
			<?php  
				...
				echo $javascript;
				echo $fim;
				echo     $registro = date("Y-m-d h-i-s");
			}else{
