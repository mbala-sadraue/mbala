...
require_once "../../config/auth.php";
	$header = '<header class="pg_main_header">
				<div>
					<p class="pg_main_header_p">Secretário/a: <span class="pg_header_nome">'.$nomeUsuario.'<span></p>
					</div>
				<div>
					...
					<section class="pg_section">
						<a href="index2.php" class="pg_section_a">
							<article class="pg_artigo">
								...
								<div>
									<p class="pg_artigo_p">Permite gerenciar secretarios, professores, alunos...</p>
								</div>
							</article>	
						</a>
						<a href="index3.php" class="pg_section_a">
							<article class="pg_artigo">
								...
								<div>
									<p class="pg_artigo_p">Ainda não foi desenvolvido. Para mais informações contata o programador</p>
								</div>
							</article>	
						</a>
