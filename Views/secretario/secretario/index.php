      ...
      echo $aside;
        echo '<section class="section_main">
          ...
          <section>
										 ...
										 echo '
											<tr class="tabela-body-tr">
												<td class="tabela-body-td">';
													if($dado->current()->secretario_Ativo ==1){echo"Ativo";}else{echo"Desativo";}
												echo'</td>
                           ...
                           <a href="'.$url2.'secretario/secretario/edita.php?id='.$dado->current()->idSecretario.'" ><img src="'.$url2.'assets/img/edita.png"  class="img edita"/></a>
									 				</span>
									...
									echo '
										<div class="corpo-message0">
											<div class="message0">
												<p class="">Nenhum dados ou secretário registrado!<br/>
